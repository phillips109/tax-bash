...
lgOf for larger of
div for division
cnum for logical calculation resulting in a numberStep 1m
...
## The next action required is at Step 1m
Here the format of the awk database has been changed.
xaddit
2name
3format
4augend
...
## As you can see the fields are now separated by lines and the records by a blank line.

This makes it possible to describe a complex logic for cnum and ctext
...
#####0
CHOOS1
WHEN01$Form1040-Copy00-line01 > 10000
VALUOF300000
WHEN02
WHEN01$Form1040-Copy00-line01 < 5000
VALUOF200000
WHEN02
OTHER1
VALUOF500000
...
## You will now complete any cnum or ctext entries.
