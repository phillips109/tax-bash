...
<xsl:variable name="QDCGTaxWkst-Copy00-lineFS">
  <xsl:choose><xsl:when test="document('../Output/Bkg_Copy00.xml')">
    <xsl:value-of select="document('../Output/Bkg_Copy00.xml')//copy00lineFS"/>
    </xsl:when><xsl:otherwise><xsl:value-of select="0"/></xsl:otherwise></xsl:choose></xsl:variable>


<xsl:variable name="QDCGTaxWkst-Copy00-lineFEI3">
  <xsl:choose><xsl:when test="document('../Output/FEITaxWkst_Copy00.xml')">
...
<xsl:variable name="QDCGTaxWkst-Copy00-linep15" select="0.15"/>


<xsl:variable name="QDCGTaxWkst-Copy00-linep20" select="0.20"/>
...
<xsl:variable name="QDCGTaxWkst-Copy00-line09">
  <xsl:value-of select="format-number($QDCGTaxWkst-Copy00-line07 - 
			$QDCGTaxWkst-Copy00-line08,'#####0')"/>
</xsl:variable>


<xsl:variable name="QDCGTaxWkst-Copy00-line12">
  <xsl:value-of select="format-number($QDCGTaxWkst-Copy00-line10 - 
			$QDCGTaxWkst-Copy00-line11,'#####0')"/>
</xsl:variable>


<xsl:variable name="QDCGTaxWkst-Copy00-line20">
  <xsl:value-of select="format-number($QDCGTaxWkst-Copy00-line10 - 
			$QDCGTaxWkst-Copy00-line19,'#####0')"/>
</xsl:variable>
...
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line01a"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line01a">
<xsl:choose>
...
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line06a"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line06a">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'MFS'">
<xsl:value-of select="41675"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line06b"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line06b">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'MFJ'">
<xsl:value-of select="83350"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line06c"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line06c">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'QSS'">
<xsl:value-of select="83350"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line06d"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line06d">
<xsl:choose>
...
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line13a"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line13a">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'MFS'">
<xsl:value-of select="258600"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line13b"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line13b">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'MFJ'">
<xsl:value-of select="517200"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line13c"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line13c">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'QSS'">
<xsl:value-of select="517200"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$QDCGTaxWkst-Copy00-line13d"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
  

<xsl:variable name="QDCGTaxWkst-Copy00-line13d">
<xsl:choose>
<xsl:when test="$QDCGTaxWkst-Copy00-lineFS = 'HOH'">
