...
<xsl:variable name="SchedB-Copy00-line04">
  <xsl:value-of select="format-number($SchedB-Copy00-line02 - 
			$SchedB-Copy00-line03,'#####0')"/>
</xsl:variable>
...
<xsl:choose><xsl:when test="document('../Data/Form1099int_Copy01_linepnam1_text.xml')">
